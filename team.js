    ...
    zh: [
      {
        ...
        name: "创始合伙人",
        role: "投资与公司构建",
        bio: "负责 thesis 形成、创始人选择与首轮融资策略，重点判断项目的问题是否成立、产品方向是否清楚，以及团队是否适合长期推进。",
      ...
      },
      {
        ...
        name: "研究合伙人",
        role: "协议设计与安全边界",
        bio: "参与机制设计、市场结构与安全分析，帮助团队把复杂技术问题整理成可执行的产品方案和研究材料。",
      ...
      },
      {
        ...
        name: "平台合伙人",
        role: "生态入口与上线推进",
        bio: "围绕生态对接、设计伙伴、上线节奏与 LP 关系做平台支持，帮助项目在进入市场时把外部协作提前准备好。",
