    ...
    zh: [
      {
        num: "01",
        title: "孵化优先",
        desc: "通常在产品方向还不够清晰时就会进入，和团队一起梳理市场、确定切入点，并准备第一轮融资材料。",
      },
      {
        num: "02",
        title: "深度尽调",
        desc: "尽调会看到架构、激励、风控与安全边界——这套材料本身也能回过头帮助产品和上线准备。",
      },
      {
        num: "03",
        title: "上线准备",
        desc: "审计、生态伙伴、白名单、流动性与市场反馈一起联动，降低产品前期最脆弱阶段的执行风险。",
      },
      {
        num: "04",
        title: "按长期来判断",
        desc: "更在意团队能否持续交付，而不是短期热度。衡量标准是业务能否站住，不是故事是否好听。",
      },
    ],
    en: [
      {
